        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-4xl font-bold text-white">📂 Categories Management</h1>
                ...
                <table class="w-full">
                    <thead class="bg-neutral-700 border-b border-neutral-600">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-200">Category Name</th>
                            <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-200">Slug</th>
                            <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-200">Description</th>
                            <th class="px-6 py-4 text-left text-sm font-semibold text-neutral-200">Created</th>
                    ...
                    <tbody>
                        @forelse($categories as $category)
                            <tr class="border-b border-neutral-700 hover:bg-neutral-700/50 transition">
                                <td class="px-6 py-4">
                                    <span class="font-mono text-neutral-400">#{{ $category->id }}</span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-3 py-1 bg-neutral-700 text-neutral-300 rounded text-xs font-mono">{{ $category->slug }}</span>
                                </td>
                                <td class="px-6 py-4">
                                    <span
                                        class="text-neutral-400 text-sm">{{ Str::limit($category->description ?? 'N/A', 50) }}</span>
                                </td>
