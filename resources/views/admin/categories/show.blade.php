        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-4xl font-bold text-white">👀 Category Details</h1>
            ...
            <div class="bg-neutral-800 rounded-xl border border-neutral-700 p-8 space-y-6">
                ...
                <!-- CATEGORY NAME -->
                <div>
                    <p class="text-neutral-400 text-sm uppercase font-semibold mb-2">Category Name</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-white">{{ $category->created_at->format('M d, Y \a\t H:i') }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-neutral-700">
                    ...
                    <div class="bg-neutral-700/50 p-4 rounded-lg">
                        ...
                        <p class="text-white">{{ $category->updated_at->format('M d, Y') }}</p>
                    </div>

                    <div class="bg-neutral-700/50 p-4 rounded-lg">
                        <p class="text-neutral-400 text-sm mb-1">Category ID</p>
                        <p class="text-white font-mono">{{ $category->id }}</p>
                    </div>
                </div>
            ...
            @if($productsCount > 0)
                <div class="mt-8">
                    <h3 class="text-2xl font-bold text-white mb-4">📦 Products in This Category</h3>
